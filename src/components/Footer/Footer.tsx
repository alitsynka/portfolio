            ...
            <div className={s.footerContainer}>
                <div className={s.infoBox}>
                    ...
                    <div className={s.form}>
                        ...
                        <p className={s.paragraph}>alina.strok@icloud.com</p>
                    </div>
                    <div className={s.form}>
                        <div className={s.iconBlock}>
                        ...
                        <p className={s.paragraph}>phone: +375-44-569-29-22</p>
                    </div>
                </div>
                <Fade bottom>
                    <div className={s.wrapper}>
                        ...
                        <span className={s.copyWriter}>©2022, All Rights Reserved </span>
                    </div>
                </Fade>
            </div>
        </div>
